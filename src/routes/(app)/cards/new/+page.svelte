...
<svelte:head>
	<title>Create New Card - Digital Card Studio</title>
	<meta name="description" content="Create a new digital business card" />
</svelte:head>

<div class="min-h-screen bg-background">
	<div class="container mx-auto px-4 py-8 max-w-7xl">
		<Button variant="ghost" onclick={() => goto('/cards')} class="mb-6">
			{#snippet children()}
				<svg
		...
		<h1 class="text-3xl font-bold text-foreground mb-8">Create New Card</h1>
				...
				<div class="flex items-start">
					...
					<div>
						...
						<p class="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
							Please complete your profile information before creating a card.
